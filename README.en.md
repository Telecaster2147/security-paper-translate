...
- `pdffonts` from poppler, for checking embedded fonts.
- `pdf2zh`, optional but recommended for strict layout preservation.
- A CJK font such as Source Han Serif CN or Noto CJK; a real CJK Bold/SemiBold face is strongly recommended.
...
When bold labels were patched in a generated PDF, also run:
